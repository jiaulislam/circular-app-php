                ...
                <form method="post">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="password" name="pass" placeholder="Your Password" class="form-control mb-3"
                                   required/>

                        </div>
                        <div class="card-footer">
                            <button type="submit" name="btn-login"
                                    class="mx-auto btn btn-primary btn-md d-flex justify-content-center align-content-between">
                                <i
