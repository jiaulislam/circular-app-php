...
select a.prj_code,a.PROJECT,a.dsgn_id,a.hr_layer,A.hr_code,A.hr_name,A.hrcode_name,A.DESIG,
a.DEV_CODE,a.dev_name,a.fyear,a.fy_premium,a.deferred,a.SING0_5,a.SING6_ABOVE,a.SING,a.Credit_FY,a.RENEWAL,a.total_premium--,a.total_cfy
from
(
SELECT --row_number() over (order by (SELECT NAME FROM IPL.ORG_ALL B WHERE B.ORG_HEAD=B.CODE)) slno,
...
decode(upper(a.PAY_STATUS),'B','7','8') hr_layer,B.ORG_HEAD DEV_CODE,
(SELECT NAME FROM IPL.ORG_ALL B WHERE B.ORG_HEAD=B.CODE) AS dev_name,
round(SUM(NVL(B.FYEAR,0)),0) fyear,round(SUM(NVL(B.FYEAR,0)+NVL(B.SING,0)),0) AS fy_premium,
round(SUM(NVL(B.SING,0)),0) AS SING,
...
--round(sum(nvl(b.FYEAR,0)+NVL(b.SING0_5*.15,0)+NVL(b.SING6_ABOVE*.20,0)+nvl(b.RENEWAL,0)),0) AS total_cfy
FROM
IT.HR_STAFF_PROJECT A, IT.HR_STAFF_BUSINESS B
...
";
        ...
        <div class="table-responsive">
            <div align="center">
                ...
                <h6>
                    ...
                    while ($row_att = oci_fetch_array($stid_att)) {
                        echo $row_att[0] . "  " . $row_att[1] . "(" . $row_att[2] . "), " . $row_att[8];
                    }
            ...
            <table class="table">
                <thead>
                <tr>
                    <th>DIVC/ Link Code</th>
                    <th>Name</th>
                    <th>First Year</th>
                    <th>Deferred Premium</th>
                    <th>Single 0-5</th>
                ...
                while ($row4 = oci_fetch_array($collection_info_stid)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="left"><?php echo $row4[10];
                                $nb_sum += $row4[10]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[12];
                                $d_sum += $row4[12]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[13];
                                $s0_sum += $row4[13]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[14];
                                $s6_sum += $row4[14]; ?></div>
                        </td>

                        <td>
                            <div align="left"><?php echo $row4[15];
                                $ts_sum += $row4[15]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[16];
                                $tc_sum += $row4[16]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[11];
                                $tg_sum += $row4[11]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[17];
                                $rp_sum += $row4[17]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[18];
                                $to_sum += $row4[18]; ?></div>
                        </td>
                    </tr>
                <?php } ?>
                <tr>
                    ...
                    <td>
                        <div align="left"><strong><?php echo $nb_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $d_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $s0_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $s6_sum; ?></strong></div>
                    </td>

                    <td>
                        <div align="left"><strong><?php echo $ts_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $tc_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $tg_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $rp_sum; ?></strong></div>
                    </td>
                    <td>
                        <div align="left"><strong><?php echo $to_sum; ?></strong></div>
                    </td>
                </tr>
                </tbody>
            </table>
