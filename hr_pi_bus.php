...
WHERE A.CODE=B.CODE and b.bmon BETWEEN '$f_mon' AND '$t_mon' and (a.prj_code='$pro_co' or '$pro_co' is null) 
...
A.CODE,A.NAME,A.DESIG,B.BMON order by  A.CODE,b.bmon asc";
        ...
        <div class="table-responsive">
            <div align="center">
                <h4>HR Staff Business Statement</h4>
                <h6><?php
            ...
            $query_code = "select distinct(CODE) from it.HR_STAFF_PROJECT_DETAILS where PRJ_CODE='$pro_co' and  code not in('0012')";
