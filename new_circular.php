        ...
        <div class="card-body">
            <form action="upload.php" method="POST" enctype="multipart/form-data">
                <div class="form">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="published_date" placeholder=""
                                   name="published_date" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="circular-no" class="form-label">Circular No</label>
                            <input type="text" class="form-control" id="circular-no" placeholder="Enter the circular no"
                                   name="circular_no" required>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="Enter title of the circular"
                                   name="title" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                        ...
                        <button type="submit" class="btn btn-primary d-flex align-items-center justify-content-center">
                            ...
                            <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                         class="bi bi-upload ms-1" viewBox="0 0 16 16">
                           ...
                           onclick="history.back()">BACK
                            ...
                            <span>
                                    <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor'
                                         class='bi bi-arrow-left-circle mx-1 d-inline-grid justify-content-center align-items-center'
                                         viewBox='0 0 16 16'>
                                        <path fill-rule='evenodd'
                    ...
                    <div class="col-md-4 d-grid">
                        <button type="reset" class="btn btn-danger d-flex align-items-center justify-content-center">
                            RESET
                            <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                         class="bi bi-x-octagon-fill ms-1" viewBox="0 0 16 16">
...
<script>
    ...
    const setDate = () => {
        let today = new Date();
        publishedDate.value = `${today.getFullYear()}-${today.getMonth() + 1}-${today.getDate()}`;
    }
</script>
