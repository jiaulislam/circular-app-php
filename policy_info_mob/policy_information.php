...
<div id="page-wrapper" style="margin-left: 0px;">
    <div class="row">
        <div class="col-lg-12">
            <h3 style="color: #006e46;margin-top: 20px;" class="page-header">Policy Information</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="panel-body">
            <div class="container-fluid">
                <div class="navbar navbar-default">
                    <form action="index.php" role="search" class="navbar-form navbar-left form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd/mm/yyyy"
                                ...
                                <div style="display: table;">
                                    <input id="birth_day" class="form-control" name="date_of_brith" size="41"
                                           type="text" placeholder="Select Birth Day (e.g. dd/mm/yyyy)"
                                           value="<?php echo $date_of_brith; ?>" required>
            ...
            $var = $date_of_brith;
            $date_of_brith = date("d-M-y", strtotime($var));

            $day = substr($date_of_brith, 0, 2);
            $month = strtoupper(substr($date_of_brith, 3, 3));
            $year = substr($date_of_brith, -2, 4);
            echo $date_of_brith_db = $day . '-' . $month . '-' . $year;
            $policy_info_query = "select policy,name,datcom,sex,(plan||'-'||term) plan,SUMASS,paymode,polopt,totprem,age,premno,sumrisk,totpaid,suspense,lprem,(oc1 || '/' ||oc2|| '/' ||oc3|| '/' ||oc4|| '/' ||oc5||'/'||oc6||'/'||oc7||'/'||oc8||'/'||oc9||'/'||oc10)as setup, pnextpay, ipl.maturity_date(datcom ,term), phone from ipl.policy where dob = '" . $date_of_brith_db . "' and policy= '" . $policy_number . "'";
            ...
            $collection_info_query = "select DISTINCT a.receipt,a.RECPTDT,a.DUEDT,a.TOTPREM,b.PRBMNO,b.PRBMDT,a.PNEXTPAY,a.amount from ipl.collection a, ipl.prbm b
