            ...
            <table class="table">
                ...
                while ($row4 = oci_fetch_array($collection_info_stid)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="left"><?php echo $row4[3];
                                $nb_sum += $row4[3]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[4];
                                $ts_sum += $row4[4]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[5];
                                $s0_sum += $row4[5]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[6];
                                $s6_sum += $row4[6]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[7];
                                $tc_sum += $row4[7]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[8];
                                $tg_sum += $row4[8]; ?></div>
                        </td>
                        <td>
                            <div align="left"><?php echo $row4[9];
                                $rp_sum += $row4[9]; ?></div>
                        </td>
                        <td>
